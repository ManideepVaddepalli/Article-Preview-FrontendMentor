...
export default function BotCardShare() {
  return (
    <div className="bot-card-share hide">
      <div className="bot-card-share-cont">
        <h4>SHARE</h4>
        <svg
          className="social"
        ...
        <button type="button" className="shareicon" onClick={shareHide}>
...
function shareHide() {
  document.querySelector(".bot-card-share").classList.add("hide");
